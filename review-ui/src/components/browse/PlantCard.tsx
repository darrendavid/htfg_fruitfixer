...
export function PlantCard({ plant }: PlantCardProps) {
  ...
  return (
    <Card
      className="overflow-hidden cursor-pointer hover:ring-2 hover:ring-ring transition-shadow min-h-[280px] flex flex-col"
    ...
    >
      ...
      <div className="p-2 flex flex-col gap-1 flex-1">
        <p className="font-bold text-sm leading-tight line-clamp-1">{plant.Canonical_Name}</p>
